...
PATTERN='claude|anthropic|chatgpt|openai|\bgpt\b|copilot|gemini|\bllm\b|language model|generative ai|ai-generated|generated by ai|generated with claude|generated by claude|vibe coding|co-authored-by|claude-session|automated implementation audit|assistant attribution|session attribution|الذكاء الاصطناعي|تم إنشاؤه بواسطة|نموذج لغوي|مساعد ذكي'
...
ALLOWLIST=(
  ...
  #
  # The line-25 hash was re-pinned once, when PATTERN was widened to
  # additionally cover commit-trailer attribution and session-identifier
  # terms. That is a CONTENT change to the pattern itself, not a silenced
  # finding: the reviewed decision — a scanner cannot avoid containing the
  # strings it searches for — is unchanged, and the line still matches
  # only itself. Every other allowlist entry keeps its original hash.
  # See docs/current-repository-cleanup.md for the re-pinning rule.
  ...
  'scripts/scan-prohibited-references.sh:25:069283e2245bde2227912cb56f8bef7a0788915a238f3fc71ac64e22cfcbc911'
