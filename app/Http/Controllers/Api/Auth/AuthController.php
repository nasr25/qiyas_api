...
use Database\Seeders\NDMOTestAccountsSeeder;
...
class AuthController extends Controller
{
    ...
    public function quickLogin(Request $request): JsonResponse
    {
        ...
        if (! in_array($request->username, [...TestUsersSeeder::usernames(), ...SumoudTestAccountsSeeder::usernames(), ...ECCTestAccountsSeeder::usernames(), ...NDMOTestAccountsSeeder::usernames()], true)) {
    ...
    public function devUsers(): JsonResponse
    {
        ...
        $users = User::whereIn('username', [...TestUsersSeeder::usernames(), ...SumoudTestAccountsSeeder::usernames(), ...ECCTestAccountsSeeder::usernames(), ...NDMOTestAccountsSeeder::usernames()])
